...
router.post("/peliculas/eliminar/:id", movieController.eliminarPelicula)       // Route -> Controller -> View/Service
router.get("/peliculas/:id", movieController.getPeliculaByTitle)
