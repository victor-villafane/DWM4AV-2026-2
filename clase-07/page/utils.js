...
export function createList(lista) {
    ...
    lista.forEach(pelicula =>
        ...
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="/peliculas/${pelicula.title}" >Ver</a>
                <a class="btn btn-warning" href="/peliculas/editar/${pelicula.title}" >Editar</a>
                <a class="btn btn-danger" href="/peliculas/eliminar/${pelicula.title}" >Borrar</a>
            </td>
        </tr>
        `
    )
